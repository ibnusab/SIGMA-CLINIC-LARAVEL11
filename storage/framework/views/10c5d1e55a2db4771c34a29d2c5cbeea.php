...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Login'); ?> - SIGMA CLINIC</title>
...
<body class="bg-gradient-to-br from-slate-900 via-sky-950 to-slate-900 min-h-screen flex items-center justify-center p-4 antialiased">
    <div class="w-full max-w-md">
        ...
        <p class="text-center text-xs text-slate-400 mt-8">&copy; <?php echo e(date('Y')); ?> SIGMA CLINIC (Laravel 11 Engine). All Rights Reserved.</p>
    </div>
</body>
</html>
<?php /**PATH D:\chrome download\android studio\laravel\sigma-clinic\resources\views/layouts/auth.blade.php ENDPATH**/ ?>