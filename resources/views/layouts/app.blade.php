...
<head>
    ...
    <title>@yield('title', 'Dashboard') - SIGMA CLINIC</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col">
    ...
    <div class="bg-clinic-800 text-white text-xs px-4 py-1.5 flex justify-between items-center shadow-inner">
        ...
        <div class="flex items-center space-x-4">
            <span class="hidden sm:inline"><i class="fa-regular fa-clock mr-1 text-sky-300"></i> {{ \Carbon\Carbon::now()->isoFormat('D MMMM YYYY, HH:mm') }} WIB</span>
        ...
        <aside id="sidebar" class="w-64 bg-slate-900 text-slate-300 hidden md:flex flex-col shrink-0 shadow-xl border-r border-slate-800 transition-all">
            ...
            <div class="mx-3 my-4 p-3 rounded-xl bg-slate-800/80 border border-slate-700/60 flex items-center space-x-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <span class="inline-block {{ $roleBadgeClass }} text-[10px] font-bold px-2 py-0.5 rounded uppercase mt-0.5">
                        {{ $roleBadgeText }}
                    </span>
                </div>
            </div>
            ...
            <nav class="flex-1 px-3 py-2 space-y-1 overflow-y-auto">
                <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('dashboard') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('patients.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('patients.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-hospital-user w-6 text-sm"></i> Data Pasien (RM)
                </a>
                <a href="{{ route('registrations.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('registrations.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-clipboard-list w-6 text-sm"></i> Pendaftaran & Antrian
                </a>
                <a href="{{ route('medical-records.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('medical-records.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('prescriptions.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('prescriptions.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-prescription-bottle-medical w-6 text-sm"></i> Resep & Pengeluaran Obat
                </a>
                <a href="{{ route('medicines.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('medicines.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('payments.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('payments.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('doctors.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('doctors.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-user-doctor w-6 text-sm"></i> Dokter Klinik
                </a>
                <a href="{{ route('clinics.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('clinics.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-clinic-medical w-6 text-sm"></i> Poli Spesialis
                </a>
                <a href="{{ route('schedules.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('schedules.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-regular fa-calendar-check w-6 text-sm"></i> Jadwal Dokter
                </a>
                <a href="{{ route('treatments.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('treatments.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-kit-medical w-6 text-sm"></i> Tarif Tindakan
                </a>
                <a href="{{ route('suppliers.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('suppliers.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                <a href="{{ route('users.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('users.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-users-gear w-6 text-sm"></i> Kelola Pengguna (User)
                </a>
                <a href="{{ route('reports.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('reports.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fa-solid fa-file-invoice-dollar w-6 text-sm"></i> Laporan & Statistik
                </a>
                <a href="{{ route('settings.index') }}" class="flex items-center px-3 py-2.5 rounded-lg text-xs font-medium transition-colors {{ request()->routeIs('settings.*') ? 'bg-sky-600 text-white font-bold shadow-md shadow-sky-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                ...
                {{-- MENU RESEPSIONIS / FRONT OFFICE --}}
                @if($isRoleResepsionis)
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-sm">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-xl font-extrabold text-slate-900 tracking-tight">@yield('title', 'Dashboard')</h2>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    @if($isRoleAdmin || $isRoleResepsionis)
                    <a href="{{ route('registrations.create') }}" class="hidden sm:flex items-center space-x-2 bg-sky-600 hover:bg-sky-700 text-white px-3.5 py-2 rounded-xl text-xs font-bold shadow-md shadow-sky-600/20 transition-all">
                        <i class="fa-solid fa-user-plus"></i>
                        <span>Daftar Kunjungan</span>
                    </a>
                    @elseif($isRoleDokter)
                    <a href="{{ route('medical-records.create') }}" class="hidden sm:flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white px-3.5 py-2 rounded-xl text-xs font-bold shadow-md shadow-emerald-600/20 transition-all">
                        <i class="fa-solid fa-stethoscope"></i>
                        <span>Pemeriksaan Baru</span>
                    </a>
                    @elseif($isRoleApoteker)
                    <a href="{{ route('prescriptions.create') }}" class="hidden sm:flex items-center space-x-2 bg-amber-600 hover:bg-amber-700 text-white px-3.5 py-2 rounded-xl text-xs font-bold shadow-md shadow-amber-600/20 transition-all">
            ...
            <footer class="bg-white border-t border-slate-200 px-6 py-4 text-center text-xs text-slate-500 flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
                <div>&copy; {{ date('Y') }} <strong>SIGMA CLINIC</strong>. All rights reserved. Powered by Laravel 11 & Tailwind CSS.</div>
